...
if (!$store_logo_error && !$business_upfile_error)
{
  ...
  if(mysqli_num_rows($result)){
      ...
      $sql .= "business_license, business_license_img, store_name, store_type, store_delivery_time, ";
      ...
      $sql .= "'$business_license', '$copied_business_file_name', '$store_name', '$store_type', '$store_delivery_time', ";
